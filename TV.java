...
public class TV {
	...
	// public static FiniteAutomaton genRandomTV(int size, double td, double fd, int alphabetSize){
		...
		// System.out.println("F before"+result.F);

		result.setInitialState(st.get(0));
		result.F.add(st.get(0));

		// System.out.println("F after"+result.F);

		
		for(int k=0;k<alphabetSize;k++){
		        added.clear(); 
			for(int n=0;n<Math.round(td*size);n++){
